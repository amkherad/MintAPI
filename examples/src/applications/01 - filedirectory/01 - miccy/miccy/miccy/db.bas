...
Public Sub OpenConfig(Optional isValidFile As Boolean = True)
    If configFL = 0 Then
        ...
        If isValidFile Then
            ...
            If validLong <> CONFIGVALIDATION Then throw InvalidFileException
            ...
            If validLong <> CONFIGVALIDATION2 Then throw InvalidFileException
            ...
            If validLong <> CONFIGLASTVALIDATION1 Then throw InvalidFileException
            ...
            If validLong <> CONFIGLASTVALIDATION2 Then throw InvalidFileException
