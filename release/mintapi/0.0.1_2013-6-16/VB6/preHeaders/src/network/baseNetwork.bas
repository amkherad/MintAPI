...
'Private Declare Function API_WSACleanup Lib "ws2_32.dll" () As Long
...
'Private Declare Function API_WSAStartup Lib "ws2_32.dll" (ByVal wVersionRequired As Integer, ByRef lpWSAData As WSADATA) As Long
