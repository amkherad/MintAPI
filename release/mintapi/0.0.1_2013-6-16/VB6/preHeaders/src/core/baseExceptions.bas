...
Public Sub throw_notifier(ByVal Object As Object, ByVal Method As String)
    tObject = Object
    tMethod = Method
End Sub
...
Private Sub notify_application(Message As String)
    exc_Counter = exc_Counter + 1
    Debug.Print Message
    If tObject Is Nothing Then Exit Sub
    If tMethod = "" Then Exit Sub
    On Error GoTo err
    Call CallByName(tObject, tMethod, VbMethod)
err:
End Sub
...
Public Sub throw0(ByRef LibraryName As String, ByRef ModuleName As String, ByVal SourceMethodName As String, ByVal ExceptionDescription As String, Optional ByVal arguments As String = "", Optional ByVal ErrorNumber As Long, Optional ByVal ExceptionType As Long, Optional HelpFile, Optional HelpContext)
    ...
    Call notify_application(ExceptionDescription)
...
Public Sub throw(Exception As Exception)
    Call notify_application(Exception.ExceptionDescription)
...
Public Function SystemException(Optional Description As String = "", Optional Location As String = "") As Exception
    If Description = "" Then
        SystemException.ExceptionDescription = ERRORS_ERROR
    Else
